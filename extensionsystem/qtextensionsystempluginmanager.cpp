...
Q_LOGGING_CATEGORY(logger_extension,"logger.extension")
...
namespace Plugin {
    ...
    void QtExtensionSystemPluginManager::addObject(QObject *obj)
    {
        ...
        {
            qCCritical(logger_extension)<<"object Repeat Add "<< obj;
            return;
        }
    ...
    void QtExtensionSystemPluginManager::removeObject(QObject *obj)
    {
        ...
        if(!obj)
        {
            qCCritical(logger_extension)<<"remove object for empty";
            return;
        }
        QMutexLocker lock(&d->_mutex);
        if(!d->_allObjects.contains(obj))
        {
            qCCritical(logger_extension)<<"object Not added "<< obj;
            return;
        }
