...
namespace Plugin{
    ...
    {
        _hasError = false;
        _errorString = _pluginName = _displayName = _displayIcon = _location = _version = QString();
    ...
    {
        qCDebug(logger_extension)<<pluginMetaData;
        _hasError = true;
        QJsonValue value;
        QJsonArray array;
        do
    ...
    bool QtExtensionSystemPluginSpecPrivate::loadLibrary()
    {
        ...
        if (_state != QtExtensionSystemPluginSpec::Resolved) {
            ...
            _hasError = true;
            qCCritical(logger_extension) << _errorString;
            return false;
        }
        if (!_loader.load()) {
            _hasError = true;
        ...
        qCInfo(logger_extension)<<_pluginName<<" Loaded successful";
    ...
    bool QtExtensionSystemPluginSpecPrivate::initializePlugin()
    {
        ...
        qCInfo(logger_extension)<<_pluginName<<" Initialized successful";
    ...
    bool QtExtensionSystemPluginSpecPrivate::initializeExtensions()
    {
        ...
        qCInfo(logger_extension)<<_pluginName<<" Running successful";
    ...
    bool QtExtensionSystemPluginSpecPrivate::delayedInitialize()
    {
        ...
        qCInfo(logger_extension)<<_pluginName<<" delayedInitialize successful";
    ...
    QtExtensionSystemPlugin::ShutdownFlag QtExtensionSystemPluginSpecPrivate::stop()
    {
        ...
        qCInfo(logger_extension)<<_pluginName<<" Stopped successful";
    ...
    void QtExtensionSystemPluginSpecPrivate::kill()
    {
        ...
        if (_loader.isLoaded())
            _loader.unload();
        qCInfo(logger_extension)<<_pluginName<<" Deleted successful";
